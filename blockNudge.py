...
row_to_add = pd.DataFrame([{'Surgeon':'test'}])
surgeonHeading = pd.concat([surgeonHeading,row_to_add])
# surgeonHeading = surgeonHeading.append({'Surgeon':'test'}, ignore_index=True)
blockHeading = pd.DataFrame()
row_to_add = pd.DataFrame([{'Block Definition':''}])
blockHeading = pd.concat([blockHeading, row_to_add])
# blockHeading = blockHeading.append({'Block Definition':''}, ignore_index=True)
dailyBlockHeading = pd.DataFrame()
row_to_add = pd.DataFrame([{'Block Date':''}])
dailyBlockHeading = pd.concat([dailyBlockHeading, row_to_add])
# dailyBlockHeading = dailyBlockHeading.append({'Block Date':''}, ignore_index=True)
procedureHeading = pd.DataFrame()
row_to_add = pd.DataFrame([{'Procedures performed in different room':''}])
procedureHeading = pd.concat([procedureHeading,row_to_add])
...
row_to_add = pd.DataFrame([{'Unused Block Times':''}])
openTimeHeading = pd.concat(openTimeHeading,row_to_add)
