...
def get_block_minutes(procedures,unit, data, block_date,room,block_stats,room_type):
    ...
    block_stats.loc[len(block_stats.index)]=[data['flexId'],block_date,unit,room,utilization,bt_minutes, nbt_minutes, total_minutes, room_type,data['blockType'],'2023-1-1','2023-1-1']
